...
/**
 ...
 and `DatabaseManager.Context.default` is used if you don't specify any custom.
 */
public extension NSManagedObject {
    ...
    class var entityDescription: NSEntityDescription? {
        return NSEntityDescription.entity(forEntityName: entityName, in: Stack.shared.defaultContext)
    }
    ...
    /**
     ...
     - parameter context: If not specified, `DatabaseManager.Context.default` will be used.
     
     - returns: New instance of `Self`.
     */
    @discardableResult class func create(in context: NSManagedObjectContext = DatabaseManager.Context.default) -> Self {
    ...
    @discardableResult class func create(with attributes: [String: Any],
                                         in context: NSManagedObjectContext = DatabaseManager.Context.default) -> Self {
    ...
    private class func _firstOrCreate<T>(with attribute: String, value: Any,
                                         in context: NSManagedObjectContext = DatabaseManager.Context.default) -> T {
    ...
    private class func _firstOrCreate<T>(with attributes: [String: Any],
        ...
        let objects = Stack.shared.execute(fetchRequest: request, in: context)
    ...
    class func all(orderedBy sortDescriptors: [NSSortDescriptor]? = nil,
                   in context: NSManagedObjectContext = DatabaseManager.Context.default) -> [NSManagedObject]? {
    ...
    /**
     ...
     - returns: Optional managed object.
     */
    class func allInBackground(orderedBy sortDescriptors: [NSSortDescriptor]? = nil,
                             in context: NSManagedObjectContext = DatabaseManager.Context.default,completion: @escaping (([NSManagedObject]) -> ())) {
        
        let request = createFetchRequest(sortDescriptors: sortDescriptors)
        Stack.shared.executeInBackground(fetchRequest: request, in: context) { objects in
            completion(objects)
        }
    }
    ...
    /**
     Finds all records(async) for given predicate.
     ...
     - returns: Optional managed object.
     */
    class func allInBackground(with predicate: NSPredicate, orderedBy sortDescriptors: [NSSortDescriptor]? = nil,in context: NSManagedObjectContext = DatabaseManager.Context.background,completion: @escaping (([NSManagedObject]) -> ())) {
        let request = createFetchRequest(predicate: predicate, sortDescriptors: sortDescriptors)
        Stack.shared.executeInBackground(fetchRequest: request, in: context) { objects in
            completion(objects)
        }
    ...
    /**
     ...
     - parameter context: If not specified, `DatabaseManager.Context.default` will be used.
     */
    func delete(from context: NSManagedObjectContext = DatabaseManager.Context.default) {
        context.delete(self)
    }
    ...
    /**
     ...
     - parameter context: If not specified, `DatabaseManager.Context.default` will be used.
     */
    class func deleteAll(from context: NSManagedObjectContext = DatabaseManager.Context.default) {
    ...
    class func deleteAll(with predicate: NSPredicate,
                         from context: NSManagedObjectContext = DatabaseManager.Context.default) {
    ...
    class func count(with predicate: NSPredicate? = nil,
                     in context: NSManagedObjectContext = DatabaseManager.Context.default) -> Int {
    ...
    class func distinctValues(for attribute: String,
                              ...
                              in context: NSManagedObjectContext = DatabaseManager.Context.default) throws -> [Any]? {
    ...
    class func distinctRecords(for attributes: [AnyHashable],
                               predicate: NSPredicate? = nil, orderedBy sortDescriptors: [NSSortDescriptor]? = nil,
                               in context: NSManagedObjectContext = DatabaseManager.Context.default) throws -> [NSDictionary]? {
